            ...
            entries: [
                {
					'name': 'recipe',
					'label': 'Recipe',
                    'fieldMsg': "Click <a href='https://soajsorg.atlassian.net/wiki/display/DSBRD/Deployment+Environment+Variables' target='_blank'>here</a> to see the list of environment variables available for each recipe type",
					'type': 'jsoneditor',
					'height': '450px',
                    'fixedHeight': true,
					'value': {},

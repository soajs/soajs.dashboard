...
service.init(function() {
	...
	// Used for 3-legged OAuth with Bitbucket
	service.get('/auth/bitbucket', function (req, res) {
		console.log('BITBUCKET CALLBACK CALLED');
		console.log('BITBUCKET CALLBACK CALLED');
		console.log('BITBUCKET CALLBACK CALLED');
		console.log('BITBUCKET CALLBACK CALLED');
		console.log('BITBUCKET CALLBACK CALLED');
	...
	service.get('/auth/bitbucket/callback', function (req, res) {
		console.log('BITBUCKET CALLBACK CALLED');
		console.log('BITBUCKET CALLBACK CALLED');
		console.log('BITBUCKET CALLBACK CALLED');
		console.log('BITBUCKET CALLBACK CALLED');

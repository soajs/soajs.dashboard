		...
		it("success - will change tenant security key", function (done) {
			mongo.findOne('environment', {'code': 'DEV'}, function (error, envRecord) {
				...
				var options = {
					...
					headers: {
						'Content-Type': 'application/json',
						key: '9skipb96ba56ce934ded56c3f21ac9bdaddc8ba4782b7753cf07576bfabcace8632eba1749ff1187239ef1f56dd74377aa1e5d0a1113de2ed18368af4b808ad245bc7da986e101caddb7b75992b14d6a866db884ea8aee5ab02786886ecf9f25e974'
					},
					body: {
						"username": "owner",
						"password": "123456"

...
var BL = {
	...
	"delete": function (config, req, res, cb) {
		validateId(req.soajs, function (err) {
			checkReturnError(req, res, {config: config, error: err, code: 409}, function () {
				checkCanEdit(req.soajs, function (err) {
					checkReturnError(req, res, {config: config, error: err, code: err}, function () {
						...
						BL.model.findEntry(req.soajs, opts, function (error, productRecord) {
							checkReturnError(req, res, {config: config, error: error, code: 414}, function () {
								checkReturnError(req, res, {config: config, error: !productRecord, code: 409}, function () {
	...
	"list": function (config, req, res, cb) {
		...
		BL.model.findEntries(req.soajs, opts, function (err, records) {
			checkReturnError(req, res, {config: config, error: err, code: 412}, function () {
	...
	"add": function (config, req, res, cb) {
		...
		BL.model.countEntries(req.soajs, opts, function (error, count) {
			checkReturnError(req, res, {config: config, error: error, code: 410}, function () {
				checkReturnError(req, res, {config: config, error: count > 0, code: 413}, function () {
					opts = {};
					opts.collection = colName;
					opts.record = record;
					BL.model.insertEntry(req.soajs, opts, function (err) {
						checkReturnError(req, res, {config: config, error: err, code: 410}, function () {
				...
				checkCanEdit(req.soajs, function (err) {
					checkReturnError(req, res, {config: config, error: err, code: err}, function () {
						...
						BL.model.updateEntry(req.soajs, opts, function (err, data) {
							checkReturnError(req, res, {config: config, error: err, code: 411}, function () {
			...
			checkReturnError(req, res, {config: config, error: err, code: 409}, function () {
				...
				checkCanEdit(req.soajs, function (err) {
					checkReturnError(req, res, {config: config, error: err, code: err}, function () {
						...
						opts.conditions = {"_id": req.soajs.inputmaskData.id};
						BL.model.findEntry(req.soajs, opts, function (error, productRecord) {
							checkReturnError(req, res, {config: config, error: error, code: 419}, function () {
								...
								checkReturnError(req, res, {
									...
									checkReturnError(req, res, {config: config, error: !found, code: 419}, function () {
										opts = {};
										opts.collection = colName;
	...
	"getPackage": function (config, req, res, cb) {
		...
		BL.model.findEntry(req.soajs, opts, function (err, product) {
			checkReturnError(req, res, {config: config, error: err || !product, code: 460}, function () {
				var pck = {};
				var found = false;
				...
				checkReturnError(req, res, {config: config, error: !found, code: 461}, function () {
		...
		validateId(req.soajs, function (err) {
			checkReturnError(req, res, {config: config, error: err, code: 409}, function () {
				...
				BL.model.findEntry(req.soajs, opts, function (err, productRecords) {
					checkReturnError(req, res, {config: config, error: err, code: 417}, function () {
							...
							checkReturnError(req, res, {
								...
								BL.model.findEntries(req.soajs, opts, function (error, environments) {
									checkReturnError(req, res, {
										...
										checkReturnError(req, res, {config: config, error: !found, code: 416}, function () {
											opts = {};
											opts.collection = colName;
											opts.record = productRecord;
											BL.model.saveEntry(req.soajs, opts, function (error) {

...
var BL = {
	 ...
	 */
	"streamLogs": function (config, soajs, registry, deployer, cbMain) {
	 ...
	 * @param {Callback} cbMain
	 */
	"maintenance": function (config, soajs, registry, deployer, cbMain) {
		var dbCollection = '';
			...
			checkIfError(soajs, cbMain, { config: config, error: error, code: 600 }, function () {
				checkIfError(soajs, cbMain, {
					...
					options.params = {
						...
						maintenancePort: record.port + registry.serviceConfig.ports.maintenanceInc,

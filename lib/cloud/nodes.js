...
var BL = {
	 ...
	 */
	"listNodes": function (config, soajs, cbMain) {
	 ...
	 * @param {Callback} cbMain
	 */
	"addNode": function (config, soajs, cbMain) {
		function getEnv(cb) {
	 ...
	 * @param {Callback} cbMain
	 */
	"removeNode": function (config, soajs, cbMain) {
	 ...
	 * @param {Callback} cbMain
	 */
	"updateNode": function (config, soajs, cbMain) {
		utils.checkErrorReturn(soajs, cbMain, {
			config: config,
			error: soajs.inputmaskData.env.toLowerCase() !== 'dashboard',
			code: 818

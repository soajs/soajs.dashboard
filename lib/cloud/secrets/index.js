		...
		utils.getEnvironment(soajs, BL.model, soajs.inputmaskData.env.toUpperCase(), function (error, envRecord) {
			checkIfError(soajs, cbMain, {
				...
				checkIfError(soajs, cbMain, {
					...
					if(options.deployerConfig && options.deployerConfig.namespace && options.deployerConfig.namespace.default){
						options.params.namespace = options.deployerConfig.namespace.default;

                        if (soajs.inputmaskData.namespace) {
                            options.params.namespace = soajs.inputmaskData.namespace;
                        }
					}
					deployer.listSecrets(options, function (error, secrets) {

							...
							if (soajs.inputmaskData.custom) {
								...
								if (soajs.inputmaskData.custom.version){
									...
									if (ciCdRecord && ciCdRecord[env]
										...
										for (let atrib in ciCdRecord[env][name].options.custom) {
											if (!Object.hasOwnProperty.call(soajs.inputmaskData.custom, atrib)) {
												soajs.inputmaskData.custom[atrib] = ciCdRecord[env][name].options.custom[atrib];
											}
										}
									}
								}

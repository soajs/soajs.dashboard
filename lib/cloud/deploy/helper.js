...
var helpers = {
	...
	getDashDbInfo: function (soajs, cb) {
		...
		//new cluster style
		if (envRecord.resources && envRecord.resources.cluster) {
			data = {
				mongoDbs: envRecord.resources.cluster['dash_cluster'].config.servers,
				mongoCred: envRecord.resources.cluster['dash_cluster'].config.credentials,
				clusterInfo: envRecord.resources.cluster['dash_cluster'].config,

...
var BL = {
	...
	"deleteService": function (config, req, deployer, cbMain) {
		async.auto({
			...
			checkIfError(req.soajs, cbMain, {config: config, error: error, code: (error) ? error.code : 600}, function () {

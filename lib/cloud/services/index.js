	...
	"scaleService": function (config, soajs, deployer, cbMain) {
		async.auto({
			...
			"callDeployer": ["getEnvironment", "getInfra", (info, mCb) => {
				...
				deployer.execute({ 'type': 'infra', 'driver': info.getInfra.name, 'technology': options.strategy }, 'scaleService', options, (error) => {
	...
	"checkResource": function (config, soajs, deployer, cbMain) {
		...
		async.auto({
			...
			"callDeployer": ["getEnvironment", "getInfra", (info, mCb) => {
				...
				deployer.execute({ 'type': 'container', 'driver': info.getInfra.name, 'technology': options.strategy }, 'listKubeServices', options, (error, services) => {

...
var data = require("../models/host.js"); //TODO: deprecate
...
function deployServiceOrDaemon(config, soajs, res) {
    var context = {
        name: '',
        origin: ''
    };
    ...
    function constructDeployerParams(cb) {
        var serviceParams = {
            ...
            "name": soajs.inputmaskData.env.toLowerCase() + "-" + context.name + ((soajs.inputmaskData.version) ? "-v" + soajs.inputmaskData.version : ""),
...
var BL = {
    ...
    "deployService": function (config, soajs, res) {
        if (soajs.inputmaskData.type === 'nginx') {
            ...
            deployServiceOrDaemon(config, soajs, res);
        }
    },
    ...
    "deployCustomService": function (config, soajs, res) {
        var serviceParams = {
            ...
            "exposedPort": soajs.inputmaskData.deployConfig.exposedPort,
            "targetPort": soajs.inputmaskData.deployConfig.targetPort
        };

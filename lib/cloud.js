    ...
    function constructDeployerParams(cb) {
        ...
        var serviceParams = {
            ...
            "labels": { //very useful when filtering
                ...
                "soajs.service.name": cleanLabel(context.dbRecord.name),
                "soajs.service.group": ((context.dbRecord.group) ? cleanLabel(context.dbRecord.group) : ''),
                "soajs.service.type": soajs.inputmaskData.type,
                "soajs.service.version": "" + soajs.inputmaskData.version,
                "soajs.service.label": cleanLabel(serviceName)
            },
            "cmd": [
                'bash',
                '-c',

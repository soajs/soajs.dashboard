...
var BL = {
	...
	"list": function (config, req, res, cb) {
		...
		BL.model.findEntries(req.soajs, opts, function (error, records) {
			var data = { model: BL.model, config: config, error: error, code: 718 };
	...
	"listGroupConfig": function (config, req, res, cb) {
		...
		BL.model.findEntries(req.soajs, opts, function (error, records) {
			var data = { model: BL.model, config: config, error: error, code: 719 };
			checkReturnError(req, cb, data, function () {
	...
	"addGroupConfig": function (config, req, res, cb) {
		...
		BL.model.countEntries(req.soajs, opts, function (error, count) {
			var data = { model: BL.model, config: config, error: error, code: 717 };
			checkReturnError(req, cb, data, function () {
				if (count > 0) {
					BL.model.closeConnection(req.soajs);
				...
				BL.model.insertEntry(req.soajs, opts, function (error, result) {
					data = { model: BL.model, config: config, error: error || !result, code: 717 };
					checkReturnError(req, cb, data, function () {
						BL.model.closeConnection(req.soajs);
						return cb(null, true);
					});
	...
	"updateGroupConfig": function (config, req, res, cb) {
		...
		validateId(req.soajs, function (error) {
			var data = { model: BL.model, config: config, error: error, code: 701 };
			checkReturnError(req, cb, data, function () {
				...
				BL.model.updateEntry(req.soajs, opts, function (error, result) {
					data = { model: BL.model, config: config, error: error || !result, code: 715 };
					checkReturnError(req, cb, data, function () {
						BL.model.closeConnection(req.soajs);
						return cb(null, true);
					});
	...
	"deleteGroupConfig": function (config, req, res, cloudBL, deployer, cb) {
		...
		validateId(req.soajs, function (error) {
			checkReturnError(req, cb, { model: BL.model, config: config, error: error, code: 701 }, function () {
				var opts = {};
				opts.collection = grpConfCol;
		...
		function doRemove() {
			...
			BL.model.removeEntry(req.soajs, opts, function (error, result) {
				var data = { model: BL.model, config: config, error: error || !result, code: 716 };
				checkReturnError(req, cb, data, function () {
					BL.model.closeConnection(req.soajs);
					return cb(null, true);
				});
		...
		validateId(req.soajs, function (error) {
			...
			checkReturnError(req, cb, data, function () {
				...
				BL.model.findEntry(req.soajs, opts, function (error, group) {
					data = { model: BL.model, config: config, error: error || !group, code: 725 };
					checkReturnError(req, cb, data, function () {
						helpers.searchForJob(req.soajs.inputmaskData.jobName, group.jobs, function (error, job) {
							data = { model: BL.model, config: config, error: error || !job, code: 724 };
							checkReturnError(req, cb, data, function () {
								...
								BL.model.saveEntry(req.soajs, opts, function (error) {
									data = { model: BL.model, config: config, error: error, code: 720 };
									checkReturnError(req, cb, data, function () {
										BL.model.closeConnection(req.soajs);
										return cb(null, true);
									});
					...
					checkReturnError(req, cb, data, function () {
						helpers.searchForJob(req.soajs.inputmaskData.jobName, group.jobs, function (error, job) {
							...
							checkReturnError(req, cb, data, function () {
								...
								opts.record = group;
								BL.model.saveEntry(req.soajs, opts, function (error) {
									data = { model: BL.model, config: config, error: error, code: 722 };
									checkReturnError(req, cb, data, function () {
										BL.model.closeConnection(req.soajs);
										return cb(null, true);
									});

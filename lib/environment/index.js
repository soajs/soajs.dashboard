								...
								"checkTemplate": function(mCb){
									if(req.soajs.inputmaskData.template){
										...
										if (process.env.SOAJS_SAAS && req.soajs.servicesConfig) {
											...
											if (req.soajs.servicesConfig.dashboard && req.soajs.servicesConfig.dashboard.SOAJS_COMPANY) {
												if (req.soajs.inputmaskData.soajs_project && req.soajs.servicesConfig.dashboard.SOAJS_COMPANY[req.soajs.inputmaskData.soajs_project]) {
													overrideNginxPorts = true;

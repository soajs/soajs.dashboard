...
function checkReturnError(req, res, data, cb) {
	if (data.error) {
...
function saveTenantRecordAndExit(tenantRecord, config, req, res, code, msg, cb) {
	console.log('saveTenantRecordAndExit');
	console.log('saveTenantRecordAndExit');
	console.log('saveTenantRecordAndExit');
	console.log('saveTenantRecordAndExit');
	console.log('saveTenant RecordAndExit');
	console.log('saveTenant RecordAndExit');
	console.log('saveTenant RecordAndExit');
	var opts = {};
	opts.collection = colName;
	...
	BL.model.saveEntry(req.soajs, opts, function (error) {
		checkReturnError(req, res, {config: config, error: error, code: code}, function () {
			var response = {};
...
var BL = {
	...
	"delete": function (config, req, res) {
		...
		validateId(req.soajs, function (error) {
			checkReturnError(req, res, {config: config, error: error, code: 438}, function () {
				checkCanEdit(req.soajs, function (err) {
					checkReturnError(req, res, {config: config, error: err, code: err}, function () {
						...
						BL.model.findEntry(req.soajs, opts, function (error, record) {
							checkReturnError(req, res, {config: config, error: error, code: 422}, function () {
								checkReturnError(req, res, {config: config, error: !record, code: 438}, function () {
	...
	"list": function (config, req, res) {
		...
		BL.model.findEntries(req.soajs, opts, function (err, records) {
			checkReturnError(req, res, {config: config, error: err, code: 422}, function () {
	...
	"add": function (config, req, res) {
		...
		BL.model.countEntries(req.soajs, opts, function (error, count) {
			checkReturnError(req, res, {config: config, error: error, code: 420}, function () {
				checkReturnError(req, res, {
					config: config,
					...
					BL.model.insertEntry(req.soajs, opts, function (err, data) {
						checkReturnError(req, res, {config: config, error: err || !data, code: 420}, function () {
		...
		function logErrorAndExit(error, body, errCode, cb) {
			...
			// checkReturnError(req, res, {config: config, error: error || body.errors});
			// opts = {};
			// opts.collection = colName;
			// opts.conditions = {'code': record.code};
			// BL.model.removeEntry(req.soajs, opts, function (error) {
			// 	checkReturnError(req, res, {config: config, error: error});
			// });
	...
	"update": function (config, req, res, cb) {
		...
		validateId(req.soajs, function (err) {
			checkReturnError(req, res, {config: config, error: err, code: 438}, function () {
				checkCanEdit(req.soajs, function (err) {
					checkReturnError(req, res, {config: config, error: err, code: err}, function () {
						opts.collection = colName;
						opts.conditions = {'_id': req.soajs.inputmaskData.id};
						...
						BL.model.updateEntry(req.soajs, opts, function (err) {
							checkReturnError(req, res, {config: config, error: err, code: 421}, function () {
		...
		validateId(req.soajs, function (err) {
			checkReturnError(req, res, {config: config, error: err, code: 438}, function () {
				...
				BL.model.findEntry(req.soajs, opts, function (err, data) {
					checkReturnError(req, res, {config: config, error: err || !data, code: 438}, function () {
						//generate oauth authorization if needed.
				...
				checkCanEdit(req.soajs, function (err) {
					checkReturnError(req, res, {config: config, error: err, code: err}, function () {
						...
						BL.model.updateEntry(req.soajs, opts, function (error) {
							checkReturnError(req, res, {config: config, error: error, code: 428}, function () {
		...
		validateId(req.soajs, function (err) {
			checkReturnError(req, res, {config: config, error: err, code: 438}, function () {
				...
				BL.model.findEntry(req.soajs, opts, function (err, tenantRecords) {
					checkReturnError(req, res, {config: config, error: err || !tenantRecords, code: 427}, function () {
		...
		validateId(req.soajs, function (err) {
			checkReturnError(req, res, {config: config, error: err, code: 438}, function () {
				...
				BL.model.findEntries(req.soajs, opts, function (err, tenantOauthUsers) {
					checkReturnError(req, res, {config: config, error: err, code: 447}, function () {
		...
		validateId(req.soajs, function (err) {
			checkReturnError(req, res, {config: config, error: err, code: 438}, function () {
				validateUid(req.soajs, function (err, uId) {
					checkReturnError(req, res, {config: config, error: err || !uId, code: 439}, function () {
						...
						BL.model.removeEntry(req.soajs, opts, function (err) {
							checkReturnError(req, res, {config: config, error: err, code: 450}, function () {
		...
		validateId(req.soajs, function (err) {
			checkReturnError(req, res, {config: config, error: err, code: 438}, function () {
				...
				BL.model.findEntry(req.soajs, opts, function (err, tenantOauthUser) {
					checkReturnError(req, res, {config: config, error: err, code: 447}, function () {
						checkReturnError(req, res, {config: config, error: tenantOauthUser, code: 448}, function () {
							...
							BL.model.insertEntry(req.soajs, opts, function (error) {
								checkReturnError(req, res, {config: config, error: error, code: 449}, function () {
				...
				validateUid(req.soajs, function (err, uId) {
					checkReturnError(req, res, {config: config, error: err || !uId, code: 439}, function () {
						...
						checkReturnError(req, res, {
							...
							BL.model.findEntry(req.soajs, opts, function (err, tenantOauthUser) {
								checkReturnError(req, res, {config: config, error: err, code: 439}, function () {
									checkReturnError(req, res, {
										config: config,
							...
							BL.model.findEntry(req.soajs, opts, function (error, tenantRecord) {
								checkReturnError(req, res, {
									...
									checkReturnError(req, res, {
										...
										saveTenantRecordAndExit(tenantRecord, config, req, res, 432, "tenant application delete successful", cb);
									});
								});
							});
						});
	...
	"listApplication": function (config, req, res, cb) {
		...
		validateId(req.soajs, function (err) {
			checkReturnError(req, res, {config: config, error: err, code: 438}, function () {
				...
				opts.conditions = {'_id': req.soajs.inputmaskData.id};
				BL.model.findEntry(req.soajs, opts, function (error, tenantRecord) {
					checkReturnError(req, res, {config: config, error: error || !tenantRecord, code: 431}, function () {
				...
				checkCanEdit(req.soajs, function (err) {
					checkReturnError(req, res, {config: config, error: err, code: err}, function () {
						...
						checkifProductAndPackageExist(req.soajs, req.soajs.inputmaskData.productCode, req.soajs.inputmaskData.packageCode, function (error, infoRecord) {
							checkReturnError(req, res, {config: config, error: error, code: 429}, function () {
								checkReturnError(req, res, {
									config: config,
									error: !infoRecord,
									code: 434
									...
									BL.model.findEntry(req.soajs, opts, function (error, tenantRecord) {
										checkReturnError(req, res, {
											...
											saveTenantRecordAndExit(tenantRecord, config, req, res, 433, "tenant application add successful", cb);
										});
									});
								});
							});
									...
									BL.model.findEntry(req.soajs, opts, function (error, tenantRecord) {
										checkReturnError(req, res, {
											...
											checkReturnError(req, res, {
												...
												saveTenantRecordAndExit(tenantRecord, config, req, res, 430, "tenant application update successful", cb);
											});
										});
									});
								});
	...
	"getTenantAcl": function (config, req, res, mainCb) {
		...
		BL.model.validateId(req.soajs, function (error, resId) {
			...
			BL.model.findEntry(req.soajs, opts, function (error, tenantRecord) {
				checkReturnError(req, res, {config: config, error: error, code: 600}, function () {
		...
		function proceedWithAcl() {
			...
			BL.model.findEntry(req.soajs, opts, function (error, productRecord) {
				checkReturnError(req, res, {config: config, error: error || !productRecord, code: 600}, function () {
					...
					getServicesAndTheirAPIs(servicesNames, function (error, servicesInfo) {
						checkReturnError(req, res, {config: config, error: error, code: error}, function () {
							var data = {
	...
	"createApplicationKey": function (config, provision, req, res, cb) {
		var opts = {};
		validateId(req.soajs, function (err) {
			checkReturnError(req, res, {config: config, error: err, code: 438}, function () {
				checkCanEdit(req.soajs, function (err) {
					checkReturnError(req, res, {config: config, error: err, code: err}, function () {
						...
						BL.model.findEntry(req.soajs, opts, function (error, tenantRecord) {
							checkReturnError(req, res, {
								...
								var x = getRequestedSubElementsPositions(tenantRecord, req);
								checkReturnError(req, res, {config: config, error: !x.found, code: 436}, function () {
									...
									provision.generateInternalKey(function (error, internalKey) {
										checkReturnError(req, res, {
											...
											saveTenantRecordAndExit(tenantRecord, config, req, res, 436, "application key add successful", cb);
										});
									});
								});
							});
	...
	"getApplicationKeys": function (config, req, res, cb) {
		...
		validateId(req.soajs, function (err) {
			checkReturnError(req, res, {config: config, error: err, code: 438}, function () {
				...
				opts.conditions = {'_id': req.soajs.inputmaskData.id};
				BL.model.findEntry(req.soajs, opts, function (error, tenantRecord) {
					checkReturnError(req, res, {config: config, error: error || !tenantRecord, code: 435}, function () {
						var keys = [];
						//find the application
						tenantRecord.applications.forEach(function (oneApplication) {
							...
							BL.model.findEntry(req.soajs, opts, function (error, tenantRecord) {
								checkReturnError(req, res, {
									...
									checkReturnError(req, res, {
										...
										saveTenantRecordAndExit(tenantRecord, config, req, res, 437, "application key remove successful", cb);
									});
								});
							});
						});
	...
	"listApplicationExtKeys": function (config, req, res, cb) {
		...
		validateId(req.soajs, function (err) {
			checkReturnError(req, res, {config: config, error: err, code: 438}, function () {
				...
				opts.conditions = {'_id': req.soajs.inputmaskData.id};
				BL.model.findEntry(req.soajs, opts, function (error, tenantRecord) {
					checkReturnError(req, res, {config: config, error: error || !tenantRecord, code: 442}, function () {
						var x = getRequestedSubElementsPositions(tenantRecord, req);
						if (x.found) {
	...
	"addApplicationExtKeys": function (config, coreProvision, coreRegistry, req, res, cb) {
		...
		function loadTenantAndRegistry() {
			coreRegistry.loadByEnv({envCode: req.soajs.inputmaskData.env.toLowerCase()}, function (error, registry) {
				checkReturnError(req, res, {config: config, error: error || !registry, code: 446}, function () {
					var opts = {
						collection: colName,
		...
		function getKeyInTenant(tenantRecord, registry) {
			var x = getRequestedSubElementsPositions(tenantRecord, req);
			checkReturnError(req, res, {config: config, error: !x.found, code: 440}, function () {
		...
		function generateDashboardExtKeyAndLeave(x, tenantRecord, registry, productLocked) {
			...
			coreProvision.generateExtKey(req.soajs.inputmaskData.key, registry.serviceConfig.key, function (error, extKeyValue) {
				checkReturnError(req, res, {config: config, error: error, code: 440}, function () {
					var newExtKey = {
						"extKey": extKeyValue,
					...
					checkReturnError(req, res, {config: config, error: err, code: err}, function () {
						...
						BL.model.findEntry(req.soajs, opts, function (error, tenantRecord) {
							checkReturnError(req, res, {
								...
								var x = getRequestedSubElementsPositions(tenantRecord, req);
								checkReturnError(req, res, {config: config, error: !x.found, code: 441}, function () {
									...
									saveTenantRecordAndExit(tenantRecord, config, req, res, 441, "tenant application ext key update successful", cb);
								});
							});
						});
					});
							...
							BL.model.findEntry(req.soajs, opts, function (error, tenantRecord) {
								checkReturnError(req, res, {
									...
									checkReturnError(req, res, {
										...
										saveTenantRecordAndExit(tenantRecord, config, req, res, 443, "tenant application ext key delete successful", cb);
									});
								});
							});
						});
						...
						BL.model.findEntry(req.soajs, opts, function (error, tenantRecord) {
							checkReturnError(req, res, {
								...
								checkIfEnvironmentExists(req.soajs, function (error, exists) {
									checkReturnError(req, res, {config: config, error: error, code: 445}, function () {
										checkReturnError(req, res, {
											config: config,
											error: !exists,
											code: 446
											...
											checkReturnError(req, res, {
												...
												saveTenantRecordAndExit(tenantRecord, config, req, res, 445, "tenant application configuration update successful", cb);
											});
										});
									});
								});
	...
	"listApplicationConfig": function (config, req, res, cb) {
		...
		validateId(req.soajs, function (err) {
			checkReturnError(req, res, {config: config, error: err, code: 438}, function () {
				...
				opts.conditions = {'_id': req.soajs.inputmaskData.id};
				BL.model.findEntry(req.soajs, opts, function (error, tenantRecord) {
					checkReturnError(req, res, {config: config, error: error || !tenantRecord, code: 444}, function () {
						var x = getRequestedSubElementsPositions(tenantRecord, req);
	...
	"extKeyGet": function (config, req, res) {
		checkReturnError(req, res, {
			...
			findExtKey(tenant, function (error, extKey) {
				checkReturnError(req, res, {config: config, error: error, code: 600}, function () {
					checkReturnError(req, res, {config: config, error: !extKey, code: 609}, function () {
	...
	"listDashboardKeys": function (config, req, res) {
		...
		BL.model.findEntry(req.soajs, opts, function (err, tenantRecord) {
			...
			checkReturnError(req, res, {config: config, error: err || !tenantRecord, code: 400}, function () {
				var keys = [];
				tenantRecord.applications.forEach(function (oneApplication) {
					oneApplication.keys.forEach(function (oneKey) {
						oneKey.extKeys.forEach(function (oneExtKey) {

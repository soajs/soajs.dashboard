...
function checkReturnError(req, mainCb, res, data, cb) {
	if (data.error) {
...
function saveTenantRecordAndExit(tenantRecord, config, req, res, code, msg, cb) {
	...
	BL.model.saveEntry(req.soajs, opts, function (error) {
		checkReturnError(req, cb, res, {config: config, error: error, code: code}, function () {
			var response = {};
...
var BL = {
	...
	"delete": function (config, req, res, cb) {
		...
		validateId(req.soajs, function (error) {
			checkReturnError(req, null, res, {config: config, error: error, code: 438}, function () {
				checkCanEdit(req.soajs, function (err) {
					checkReturnError(req, null, res, {config: config, error: err, code: err}, function () {
						...
						BL.model.findEntry(req.soajs, opts, function (error, record) {
							checkReturnError(req, null, res, {config: config, error: error, code: 422}, function () {
								checkReturnError(req, null, res, {
									config: config,
									error: !record,
									code: 438
								}, function () {
	...
	"list": function (config, req, res, cb) {
		...
		BL.model.findEntries(req.soajs, opts, function (err, records) {
			checkReturnError(req, null, res, {config: config, error: err, code: 422}, function () {
	...
	"add": function (config, req, res, cb) {
		...
		BL.model.countEntries(req.soajs, opts, function (error, count) {
			checkReturnError(req, null, res, {config: config, error: error, code: 420}, function () {
				checkReturnError(req, null, res, {
					config: config,
					...
					BL.model.insertEntry(req.soajs, opts, function (err, data) {
						checkReturnError(req, null, res, {config: config, error: err || !data, code: 420}, function () {
		...
		function logErrorAndExit(error, body, errCode, cb) {
			...
			// checkReturnError(req, null, res, {config: config, error: error || body.errors});
			// opts = {};
			// opts.collection = colName;
			// opts.conditions = {'code': record.code};
			// BL.model.removeEntry(req.soajs, opts, function (error) {
			// 	checkReturnError(req, null, res, {config: config, error: error});
			// });
			// return cb({"code": errCode, "msg": config.errors[errCode]});
			// }
			// else cb();
			if (error) {
	...
	"update": function (config, req, res, cb) {
		...
		validateId(req.soajs, function (err) {
			checkReturnError(req, null, res, {config: config, error: err, code: 438}, function () {
				checkCanEdit(req.soajs, function (err) {
					checkReturnError(req, null, res, {config: config, error: err, code: err}, function () {
						opts.collection = colName;
						opts.conditions = {'_id': req.soajs.inputmaskData.id};
						...
						BL.model.updateEntry(req.soajs, opts, function (err) {
							checkReturnError(req, null, res, {config: config, error: err, code: 421}, function () {
		...
		validateId(req.soajs, function (err) {
			checkReturnError(req, null, res, {config: config, error: err, code: 438}, function () {
				...
				BL.model.findEntry(req.soajs, opts, function (err, data) {
					checkReturnError(req, null, res, {config: config, error: err || !data, code: 438}, function () {
						//generate oauth authorization if needed.
				...
				checkCanEdit(req.soajs, function (err) {
					checkReturnError(req, null, res, {config: config, error: err, code: err}, function () {
						...
						BL.model.updateEntry(req.soajs, opts, function (error) {
							checkReturnError(req, null, res, {config: config, error: error, code: 428}, function () {
		...
		validateId(req.soajs, function (err) {
			checkReturnError(req, null, res, {config: config, error: err, code: 438}, function () {
				...
				BL.model.findEntries(req.soajs, opts, function (err, tenantOauthUsers) {
					checkReturnError(req, null, res, {config: config, error: err, code: 447}, function () {
		...
		validateId(req.soajs, function (err) {
			checkReturnError(req, null, res, {config: config, error: err, code: 438}, function () {
				validateUid(req.soajs, function (err, uId) {
					checkReturnError(req, null, res, {config: config, error: err || !uId, code: 439}, function () {
						...
						BL.model.removeEntry(req.soajs, opts, function (err) {
							checkReturnError(req, null, res, {config: config, error: err, code: 450}, function () {
				...
				validateUid(req.soajs, function (err, uId) {
					checkReturnError(req, null, res, {config: config, error: err || !uId, code: 439}, function () {
						...
						checkReturnError(req, null, res, {
							...
							BL.model.findEntry(req.soajs, opts, function (err, tenantOauthUser) {
								checkReturnError(req, null, res, {config: config, error: err, code: 439}, function () {
									checkReturnError(req, null, res, {
										config: config,
										error: tenantOauthUser,
										code: 448
				...
				checkCanEdit(req.soajs, function (err) {
					checkReturnError(req, null, res, {config: config, error: err, code: err}, function () {
						...
						checkifProductAndPackageExist(req.soajs, req.soajs.inputmaskData.productCode, req.soajs.inputmaskData.packageCode, function (error, infoRecord) {
							checkReturnError(req, null, res, {config: config, error: error, code: 429}, function () {
								checkReturnError(req, null, res, {
									config: config,
									error: !infoRecord,
									code: 434
	...
	"getTenantAcl": function (config, req, res, mainCb) {
		...
		BL.model.validateId(req.soajs, function (error, resId) {
			...
			BL.model.findEntry(req.soajs, opts, function (error, tenantRecord) {
				checkReturnError(req, mainCb, res, {config: config, error: error, code: 600}, function () {
		...
		function proceedWithAcl() {
			...
			BL.model.findEntry(req.soajs, opts, function (error, productRecord) {
				checkReturnError(req, mainCb, res, {
					config: config,
					...
					getServicesAndTheirAPIs(servicesNames, function (error, servicesInfo) {
						checkReturnError(req, mainCb, res, {config: config, error: error, code: error}, function () {
							var data = {
	...
	"addApplicationExtKeys": function (config, coreProvision, coreRegistry, req, res, cb) {
		...
		function loadTenantAndRegistry() {
			coreRegistry.loadByEnv({envCode: req.soajs.inputmaskData.env.toLowerCase()}, function (error, registry) {
				checkReturnError(req, null, res, {config: config, error: error || !registry, code: 446}, function () {
					var opts = {
						collection: colName,
		...
		function getKeyInTenant(tenantRecord, registry) {
			var x = getRequestedSubElementsPositions(tenantRecord, req);
			checkReturnError(req, null, res, {config: config, error: !x.found, code: 440}, function () {
		...
		function generateDashboardExtKeyAndLeave(x, tenantRecord, registry, productLocked) {
			...
			coreProvision.generateExtKey(req.soajs.inputmaskData.key, registry.serviceConfig.key, function (error, extKeyValue) {
				checkReturnError(req, null, res, {config: config, error: error, code: 440}, function () {
					var newExtKey = {
						"extKey": extKeyValue,
	...
	"listApplicationConfig": function (config, req, res, cb) {
		var opts = {};
		validateId(req.soajs, function (err) {
			checkReturnError(req, cb, res, {config: config, error: err, code: 438}, function () {
				opts.collection = colName;
				opts.conditions = {'_id': req.soajs.inputmaskData.id};
				BL.model.findEntry(req.soajs, opts, function (error, tenantRecord) {
					checkReturnError(req, cb, res, {
						config: config,
						error: error || !tenantRecord,
						code: 444
					}, function () {
	...
	"permissionsGet": function (config, req, res, cbMain) {
		checkReturnError(req, cbMain, res, {
			config: config,
			...
			if (req.soajs.inputmaskData.envCode) {
				...
				return cbMain(null, {"acl": ACL});
			}
			else {
				getUserAllAclPerKey(function (info) {
					return cbMain(null, info);
				});
			}
		});
		...
		function getUserAllAclPerKey(cb) {
			...
			BL.model.findEntries(req.soajs, opts, function (error, envCodesRecords) {
				checkReturnError(req, cbMain, res, {config: config, error: error, code: 600}, function () {
	...
	"extKeyGet": function (config, req, res, cbMain) {
		checkReturnError(req, cbMain, res, {
			config: config,
			...
			findExtKey(tenant, function (error, extKey) {
				checkReturnError(req, cbMain, res, {config: config, error: error, code: 600}, function () {
					checkReturnError(req, cbMain, res, {config: config, error: !extKey, code: 609}, function () {
						return cbMain(null, {extKey: extKey});
					});
				});
			});
		});
	...
	"listDashboardKeys": function (config, req, res, cb) {
		...
		BL.model.findEntry(req.soajs, opts, function (err, tenantRecord) {
			...
			checkReturnError(req, cb, res, {config: config, error: err || !tenantRecord, code: 400}, function () {
				var keys = [];
				tenantRecord.applications.forEach(function (oneApplication) {
					oneApplication.keys.forEach(function (oneKey) {
						oneKey.extKeys.forEach(function (oneExtKey) {

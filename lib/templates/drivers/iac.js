														...
														if (oneRecipe.inputs) {
															...
															if (oneRecipe.inputs && oneRecipe.inputs.length > 0) {
																if (typeof oneRecipe.inputs === 'string') {
																	try {
                                                                        req.soajs.inputmaskData.inputs = JSON.parse(oneRecipe.inputs, null, 2);
																	} catch (e) {
																		return lCb(e);
                                                                    }
                                                                } else {
															...
															if (oneRecipe.display && Object.keys(oneRecipe.display).length > 0) {
                                                                if (typeof oneRecipe.display === 'string') {
                                                                    try {
                                                                        req.soajs.inputmaskData.display = JSON.parse(oneRecipe.display, null, 2);
                                                                    } catch (e) {
                                                                        return lCb(e);
                                                                    }
                                                                } else {
															...
															if (oneRecipe.imfv && Object.keys(oneRecipe.imfv).length > 0) {
                                                                if (typeof oneRecipe.imfv === 'string') {
                                                                    try {
                                                                        req.soajs.inputmaskData.imfv = JSON.parse(oneRecipe.imfv, null, 2);
                                                                    } catch (e) {
                                                                        return lCb(e);
                                                                    }
                                                                } else {

                    ...
                    checkIfError(req, res, {config: config, error: envRecord.deployer.type === 'manual', code: 618}, function () {
                        ...
                        var dockerParams = {
                            ...
                            "Cmd": [
                                'bash',
                                '-c',
                                'cd /opt/soajs/node_modules/controller/; npm install; /opt/soajs/FILES/scripts/runService.sh; /opt/soajs/node_modules/controller/index.js'
                            ]
                        };
                        ...
                        checkIfError(req, res, {config: config, error: err || !serviceRecord, code: 600}, function () {
                            ...
                            var dockerParams = {
                                ...
                                "Cmd": [
                                    'bash',
                                    '-c',
                                    'cd /opt/soajs/node_modules/' + serviceName + '/; npm install; /opt/soajs/FILES/scripts/runService.sh; /opt/soajs/node_modules/' + serviceName + 'index.js'
                                ]
                            };
                            ...
                            dockerParams.variables.push("SOAJS_SRV_AUTOREGISTERHOST=true");

        ...
        function registerNewHost(data, deployerConfig, cb) {
            ...
            mongo.insert("docker", document, function (error) {
                checkIfError(req, res, {config: config, error: error, code: 615}, function () {
                    ...
                    newHost.ip = (deployerConfig.selectedDriver === 'docker - socket' ? data.NetworkSettings.IPAddress : data.NetworkSettings.Networks[deployerConfig.config.HostConfig.NetworkMode].IPAddress);

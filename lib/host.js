...
var BL = {
	 ...
	 * @ param response
	 */
	"listHostEnv": function (config, soajs, deployer, cbMain) {
		if (process.env.SOAJS_DEPLOY_HA) {
			BL.listHAhostEnv(config, soajs, deployer, cbMain);
		}
		else {
	...
	"listHAhostEnv": function (config, soajs, deployer, cbMain) {
		var output = {};
	...
	"maintenanceOperation": function (config, soajs, deployer, cbMain) {

                                        ...
                                        checkIfError(req, res, {
                                            ...
                                            var dockerParams = {
                                                ...
                                                "variables": [
                                                    ...
                                                    "SOAJS_GIT_BRANCH=" + req.soajs.inputmaskData.branch//ctrlRecord.src.branch
                                                ],
                                                "Cmd": [
                                                    'bash',
                                                    '-c',
                                    ...
                                    checkIfError(req, res, {
                                        ...
                                        var dockerParams = {
                                            ...
                                            "variables": [
                                                ...
                                                "SOAJS_GIT_BRANCH=" + req.soajs.inputmaskData.branch //serviceRecord.src.branch
                                            ],
                                            "Cmd": [
                                                'bash',
                                                '-c',
                                    ...
                                    checkIfError(req, res, {
                                        ...
                                        var dockerParams = {
                                            ...
                                            "variables": [
                                                ...
                                                "SOAJS_GIT_BRANCH=" + req.soajs.inputmaskData.branch //daemonRecord.src.branch
                                            ],
                                            "Cmd": [
                                                'bash',
                                                '-c',
                    ...
                    checkIfError(req, res, {config: config, error: err, code: 600}, function () {
                        mongo.find('docker', {env: req.soajs.inputmaskData.env.toLowerCase()}, function (err, containers) {
                            checkIfError(req, res, {config: config, error: err, code: 600}, function () {
                                ...
                                return res.jsonp(req.soajs.buildResponse(null, {'hosts': hosts, 'deployer': envRecord.deployer}));
                            });
                        });
                    });
                });

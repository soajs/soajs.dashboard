				...
				checkIfError(req, res, {config: config, error: error, code: 600}, function () {
					...
					checkIfError(req, res, {config: config, error: !envRecord.deployer.type || !envRecord.deployer.selected, code: 743}, function () {
						...
						checkIfError(req, res, {
							config: config,
							error: !deployerConfig[driver[0]] || !deployerConfig[driver[0]][driver[1]] || !deployerConfig[driver[0]][driver[1]][driver[2]] || (driver[2] === "cloud" && !!deployerConfig[driver[0]][driver[1]][driver[2][driver[3]]]),
							code: 743
						}, function () {

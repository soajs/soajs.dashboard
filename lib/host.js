                                        ...
                                        checkIfError(req, res, {
                                            ...
                                            var dockerParams = {
                                                ...
                                                "Cmd": [
                                                    'bash',
                                                    '-c',
                                                    '/opt/soajs/FILES/scripts/runService.sh ' + ctrlRecord.src.main
                                                ]
                                            };
                                    ...
                                    checkIfError(req, res, {
                                        ...
                                        var dockerParams = {
                                            ...
                                            "Cmd": [
                                                'bash',
                                                '-c',
                                                '/opt/soajs/FILES/scripts/runService.sh ' + serviceRecord.src.main
                                            ]
                                        };
                                    ...
                                    checkIfError(req, res, {
                                        ...
                                        var dockerParams = {
                                            ...
                                            "Cmd": [
                                                'bash',
                                                '-c',
                                                '/opt/soajs/FILES/scripts/runService.sh ' + daemonRecord.src.main
                                            ]
                                        };

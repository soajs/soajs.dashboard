...
var BL = {
	...
	'login': function (config, req, git, deployer, cbMain) {
		var record = {
	...
	'logout': function (config, req, git, deployer, cbMain) {
	...
	'listAccounts': function (config, req, git, deployer, cbMain) {
	...
	'getRepos': function (config, req, git, deployer, cbMain) {
		validateId(req.soajs, function (error) {
			checkReturnError(req, cbMain, {config: config, error: error, code: 701}, function () {
				var options = {
					provider: req.soajs.inputmaskData.provider,
	...
	'getBranches': function (config, req, git, deployer, cbMain) {
	...
	'activateRepo': function (config, req, git, deployer, cbMain) {
		var configSHA = [];
		validateId(req.soajs, function (error) {
			checkReturnError(req, cbMain, {config: config, error: error, code: 701}, function () {
	...
	'deactivateRepo': function (config, req, git, deployer, cbMain) {
		validateId(req.soajs, function (error) {
			checkReturnError(req, cbMain, {config: config, error: error, code: 701}, function () {
	...
	'syncRepo': function (config, req, git, deployer, cbMain) {
		validateId(req.soajs, function (error) {
			checkReturnError(req, cbMain, {config: config, error: error, code: 701}, function () {
	 ...
	 * @param cbMain
	 */
	'getFile': function (config, req, git, deployer, cbMain) {
		gitModel.getAccount(req.soajs, BL.model, {

...
var BL = {
    ...
    'login': function (config, req, res) {
        ...
        git.login(req.soajs, data, BL.model, record, function (error, result) {
            checkReturnError(req, res, {config: config, error: error, code: (error && error.code && config.errors[error.code]) ? error.code : 751}, function () {
    ...
    'logout': function (config, req, res) {
        validateId(req.soajs, function (error) {
            checkReturnError(req, res, {config: config, error: error, code: 701}, function () {
                var options = {
                ...
                git.logout(req.soajs, data, BL.model, options, function (error, result) {
                    checkReturnError(req, res, {config: config, error: error, code: (error && error.code && config.errors[error.code]) ? error.code : 753}, function () {
                        return res.jsonp(req.soajs.buildResponse(null, true));
                    });
                });
            });
    ...
    'listAccounts': function (config, req, res) {
        data.listGitAccounts(req.soajs, BL.model, function (error, records) {
            checkReturnError(req, res, {config: config, error: error, code: 756}, function () {
        ...
        validateId(req.soajs, function (error) {
            checkReturnError(req, res, {config: config, error: error, code: 701}, function () {
                ...
                git.getRepos(req.soajs, data, BL.model, options, function (error, repos) {
                    checkReturnError(req, res, {config: config, error: error, code: (error && error.code && config.errors[error.code]) ? error.code : 757}, function () {
        ...
        if (req.soajs.inputmaskData.type === 'repo') {
            validateId(req.soajs, function (error) {
                checkReturnError(req, res, {config: config, error: error, code: 701}, function () {
                    ...
                    checkReturnError(req, res, {config: config, error: !req.soajs.inputmaskData.provider, code: 775}, function () {
                        var options = {
                            accountId: req.soajs.inputmaskData.id,
                        ...
                        git.getBranches(req.soajs, data, BL.model, options, function (error, result) {
                            checkReturnError(req, res, {config: config, error: error, code: (error && error.code && config.errors[error.code]) ? error.code : 759}, function () {
            ...
            getContentInfo(function (error, info) {
                ...
                data.getAccount(req.soajs, BL.model, {owner: info.src.owner, repo: info.src.repo}, function (error, accountRecord) {
                    checkReturnError(req, res, {config: config, error: error || !accountRecord, code: 759}, function () {
                        var options = {
        ...
        validateId(req.soajs, function (error) {
            checkReturnError(req, res, {config: config, error: error, code: 701}, function () {
                data.getAuthToken(req.soajs, BL.model, {accountId: req.soajs.inputmaskData.id}, function (error, token) {
                    checkReturnError(req, res, {config: config, error: error, code: 755}, function () {
                        checkReturnError(req, res, {config: config, error: !config.gitAccounts[req.soajs.inputmaskData.provider], code: 778}, function () {
                                        ...
                                        checkReturnError(req, res, {
                                            ...
                                            cleanConfigDir(req, {repoConfigsFolder: config.gitAccounts[req.soajs.inputmaskData.provider].repoConfigsFolder}, function () {
                                                ...
                                                addNew(repoInfo.type, repoInfo.info, function (error, result) {
                                                    checkReturnError(req, res, {config: config, error: error, code: 761}, function () {
                                                        var newRepo = {
        ...
        validateId(req.soajs, function (error) {
            checkReturnError(req, res, {config: config, error: error, code: 701}, function () {
                ...
                data.getRepo(req.soajs, BL.model, {accountId: req.soajs.inputmaskData.id, repoLabel: repoLabel}, function (error, record) {
                    checkReturnError(req, res, {config: config, error: error || !record, code: 765}, function () {
        ...
        validateId(req.soajs, function (error) {
            checkReturnError(req, res, {config: config, error: error, code: 701}, function () {
                data.getAccount(req.soajs, BL.model, {accountId: req.soajs.inputmaskData.id}, function (error, accountRecord) {
                    checkReturnError(req, res, {config: config, error: error || !accountRecord, code: 767}, function () {
                        var repoLabel = req.soajs.inputmaskData.owner + '/' + req.soajs.inputmaskData.repo;
                        var configSHA;
                        ...
                        checkReturnError(req, res, {config: config, error: !req.soajs.data || !req.soajs.data.configBranch, code: 767}, function () {
                            checkReturnError(req, res, {config: config, error: !config.gitAccounts[req.soajs.inputmaskData.provider], code: 778}, function () {
	...
	'getFile': function (config, req, res) {
		data.getAccount(req.soajs, BL.model, {
			...
			checkReturnError(req, res, {config: config, error: error || !account, code: 757}, function () {
				if(process.env.SOAJS_DEPLOY_HA){
					BL.model.findEntry(req.soajs, {
						...
						checkReturnError(req, res, {config: config, error: error || !account, code: 600}, function () {

							var options = buildDeployerOptions(oneEnvironment, req.soajs);
							checkReturnError(req, res, {config: config, error: !options, code: 825}, function () {
								...
								deployer.findService(options, function (error, oneService) {
									checkReturnError(req, res, {config: config, error: error}, function () {
										checkReturnError(req, res, {config: config, error: !oneService, code: 604}, function () {
											var branch = "master";
		...
		function doGetFile(account,branch){
			...
			git.getAnyContent(req.soajs, data, BL.model, options, function (error, fileData) {
				checkReturnError(req, res, {config: config, error: error, code: 789}, function () {

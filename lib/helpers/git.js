...
var helpers = {
	...
	deleteMulti: function (soajs, model, cb) {
		...
		async.parallel([ getRepoServices, getRepoDaemons ], function (error, repoContents) {
			...
			model.countEntries(soajs, opts, function (error, count) {
				checkMongoError(soajs, error, cb, function () {
					...
					async.parallel([ removeService, removeDaemon, removeStatic ], function (error, reesults) {
		...
		function removeStatic (callback) {
			var opts = {
	...
	addNewStaticContent: function (soajs, model, configSHA, type, staticContentInfo, cb) {
		...
		model.insertEntry(soajs, opts, function (error) {
			checkMongoError(soajs, error, cb, function () {
				var added = {
					type: 'static',

    ...
    function constructDeployerParams(cb) {
        ...
        var serviceParams = {
            ...
            "replication": {
                ...
                "replicas": soajs.inputmaskData.deployConfig.replication.replicas
            },
    	...
    	if(soajs.inputmaskData.deployConfig.isKubernetes){
		    ...
		    if(soajs.inputmaskData.deployConfig.replication.mode === 'global'){
			    soajs.inputmaskData.deployConfig.replication.mode = "daemonset";
			    delete soajs.inputmaskData.deployConfig.replication.replicas;
		    }
	    }

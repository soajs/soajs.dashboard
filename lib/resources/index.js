                                	...
                                	async.series({
										...
										"markDeployed": (fCb) => {
                                            ...
                                            for (var i = 0; i < deployedServices.length; i++) {
                                                if (deployedServices[i].labels && deployedServices[i].labels['soajs.resource.id'] === oneResource._id.toString()) {
                                                    oneResource.isDeployed = true;
                                                    oneResource.instance = deployedServices[i];
                                                }
                                                else if (deployedServices[i].name === oneResource.name && deployedServices[i].labels["soajs.service.technology"] === "vm") {
                                                    oneResource.isDeployed = true;
                                                    oneResource.instance = deployedServices[i];
                                                    oneResource.canBeDeployed = true;

...
var BL = {
		...
		validateId(req.soajs, function (error) {
			checkReturnError(req, res, {config: config, error: error, code: 701}, function () {
				...
				BL.model.findEntry(req.soajs, opts, function (error, response) {
					checkReturnError(req, res, {config: config, error: error, code: 600}, function () {
						checkReturnError(req, res, {config: config, error: !response, code: 702}, function () {
							return res.jsonp(req.soajs.buildResponse(null, response));
						});
					});
				});
	...
	"revisions": function (config, req, res) {
		var opts = {};
	...
	"add": function (config, req, res) {
		...
		BL.model.findEntry(req.soajs, opts, function (error, response) {
			checkReturnError(req, res, {config: config, error: error, code: 600}, function () {
				checkReturnError(req, res, {config: config, error: response, code: 700}, function () {
					opts = {};
					opts.collection = collectionName;
					opts.record = record;
		...
		validateId(req.soajs, function (error) {
			checkReturnError(req, res, {config: config, error: error, code: 701}, function () {
				...
				BL.model.findEntry(req.soajs, opts, function (error, oldServiceConfig) {
					checkReturnError(req, res, {config: config, error: error, code: 600}, function () {
						checkReturnError(req, res, {config: config, error: !oldServiceConfig, code: 702}, function () {

...
var BL = {
     ...
     *
     */
    cdDeploy: function (config, req, deployer, cb) {
     ...
     * @param  {Function}           cb
     */
    getUpdates: function (config, req, deployer, cb) {
        ...
        function getServices(cb) {
            var cloudServices = require("../cloud/services.js");
     ...
     * @param cb
     */
    cdAction: function(config, registry, req, deployer, cb){
        function initBLModel (BLModule, modelName, cb) {
            BLModule.init(modelName, cb);
        }

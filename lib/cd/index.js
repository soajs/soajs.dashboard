    ...
    cdAction: function(config, req, cb){
        ...
        function redeployService(cb) {
            ...
            initBLModel(servicesBL, 'mongo', function(error, BL){
                ...
                /**
                 * construct req.soajs.inputmaskData to match what redeploy service actually takes
                 *
                 *  action:"redeploy"
                 *  env:"DEV"
                 *  mode:"replicated"
                 *  serviceId:"s5uym6mg3tealyyh4un2ovfif"
                 */
        ...
        /**
         * add the business logic of the api and call the functions above
         */
    }
